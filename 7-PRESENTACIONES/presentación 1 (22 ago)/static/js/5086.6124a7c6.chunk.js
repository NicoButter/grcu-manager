...
`,u=(s.Ay.canvas({width:"100%",height:"100%",pointerEvents:"none",position:"absolute",top:0,left:0,zIndex:3}),e=>{let{items:t,renderItem:n,keyExtractor:s,getComputedStyles:u,forcedRows:c}=e;const m=(0,a.f)(t.length,c);return(0,i.jsx)(l,{children:(0,i.jsx)(d,{numColumns:m.numColumns,numRows:m.numRows,children:(0,i.jsx)(r.N,{children:t.map(((e,t)=>(0,i.jsx)(o.P.div,{layout:!0,style:u?u(e,t):void 0,initial:{opacity:0,scale:.7},animate:{opacity:1,scale:1},transition:{type:"spring",ease:"easeInOut",stiffness:30,damping:10},"data-testid":`grid-item-${s(e)}`,children:n(e)},s(e))))})})})})},30555:(e,t,n)=>{n.d(t,{u:()=>a});var i=n(54072);const r=e=>null!==e,o=(e,t)=>{var n;const i=null===(n=e.image)||void 0===n?void 0:n.source;return i?{id:t,src:i,title:e.title,altText:e.image.altText||""}:null},a=function(e){let t=arguments.length>1&&void 0!==arguments[1]&&arguments[1];return e.flatMap((e=>{const n=(0,i.Ak)(),r=o(e,`${n}-original`),a=t?o(e,`${n}-pair`):((e,t)=>{var n,i;const r=null===(n=e.imagePair)||void 0===n?void 0:n.source;return r?{id:t,src:r,title:e.titlePair||e.title,altText:(null===(i=e.imagePair)||void 0===i?void 0:i.altText)||""}:null})(e,`${n}-pair`);return[r,a]})).filter(r)}},76838:(e,t,n)=>{n.d(t,{f:()=>r,v:()=>i});const i=e=>{if("auto"===e)return;const t=Number(e);if(!Number.isNaN(t))return t;console.warn("Cannot parse row distribution. Setting to auto",e)},r=(e,t)=>t?((e,t)=>e<t?{numColumns:1,numRows:e}:{numColumns:Math.ceil(e/t),numRows:t})(e,t):(e=>{if(e<4)return{numColumns:1,numRows:e};let t=4;for(;e%t!==0&&t<7;)t+=1;return{numColumns:t,numRows:Math.ceil(e/t)}})(e)},22705:(e,t,n)=>{n.r(t),n.d(t,{geniallyFindThePairViewScript:()=>y});var i=n(45992),r=n(84054),o=n(41381),a=n(17588),s=n(37577),l=n(89690),d=n(56292);var u;!function(e){e.FACEDOWN="faceDown",e.FACEUP="faceUp",e.BURNED="burned"}(u||(u={}));const c=e=>e.replace("-original","-pair");var m=n(11833);const p=(e,t)=>{const n=e%2===1,i=t%2===1;return n&&!i?1:!n&&i?-1:e-t},f=e=>{let{theme:t,images:n,coverImageSrc:r,fitImages:o,rowsDitributionFromConfig:f,onSuccess:g,onFailure:h,onGameWon:b}=e;const{shuffledCards:v,isFaceUp:y,isBurned:w,onPick:x}=((e,t,n,i)=>{const r=(0,a.useMemo)((()=>{const t=e.map((e=>{return Object.assign(Object.assign({},e),{id:e.id,pairId:e.id.includes("-pair")?(t=e.id,t.replace("-pair","-original")):c(e.id)});var t}));for(let e=t.length-1;e>0;e-=1){const n=Math.floor(Math.random()*(e+1));[t[e],t[n]]=[t[n],t[e]]}return t}),[e]),[o,s]=(0,a.useState)((()=>{const e=new Map;return r.forEach((t=>{e.set(t.id,{id:t.id,status:u.FACEDOWN,pairId:t.pairId})})),e})),l=(0,a.useCallback)((e=>{var t;return(null===(t=o.get(e))||void 0===t?void 0:t.status)===u.FACEUP}),[o]),d=(0,a.useCallback)((e=>{var t;return(null===(t=o.get(e))||void 0===t?void 0:t.status)===u.BURNED}),[o]);return{shuffledCards:r,isFaceUp:l,isBurned:d,onPick:e=>{const r=o.get(e);if(r.status!==u.FACEDOWN)return;const a=[...o.values()].filter((e=>e.status===u.FACEUP));if(0===a.length)o.set(r.id,Object.assign(Object.assign({},r),{status:u.FACEUP}));else if(1===a.length){const e=a[0];e.pairId===r.id?(o.set(e.id,Object.assign(Object.assign({},e),{status:u.BURNED})),o.set(r.id,Object.assign(Object.assign({},r),{status:u.BURNED})),t()):(o.set(r.id,Object.assign(Object.assign({},r),{status:u.FACEUP})),n())}else 2===a.length&&(a.forEach((e=>{o.set(e.id,Object.assign(Object.assign({},e),{status:u.FACEDOWN}))})),o.set(r.id,Object.assign(Object.assign({},r),{status:u.FACEUP})));s(new Map(o)),[...o.values()].every((e=>e.status===u.BURNED))&&i()}}})(n,(()=>{setTimeout((()=>{g()}),m.rl)}),(()=>{setTimeout((()=>{h()}),m.rl)}),(()=>{setTimeout((()=>{b()}),m.rl)})),[C,E]=(0,a.useState)((()=>Array.from({length:v.length},((e,t)=>t))));return(0,a.useEffect)((()=>{E((e=>[...e].sort(p).reverse()))}),[]),(0,i.jsx)(s.NP,{theme:t,children:(0,i.jsx)(d.x,{items:v,forcedRows:f,renderItem:e=>(0,i.jsx)(l.Z,{title:e.title,frontImageSrc:e.src,coverImageSrc:r,fitImages:o,flipped:y(e.id)||w(e.id),burned:w(e.id),onClick:()=>x(e.id)}),keyExtractor:e=>e.id,getComputedStyles:(e,t)=>({order:C[t]})})})};var g=n(30555),h=n(76838);const b="https://audios.genial.ly/59e059d30b9c21060cb4c2ec/de8b3efe-c4df-48ff-8bbb-2b3e940663d3.wav",v="https://audios.genial.ly/59e059d30b9c21060cb4c2ec/23fe908b-44e2-4972-981f-d857c429b126.wav",y=(e,t)=>{e.slide.audioRequirement=r.w.ShowMute;const n=e.config.itemList,a=(0,g.u)(n,e.config.identicalImages);(0,o.p)({getTargetNodeItem:()=>e.item,initialState:void 0,renderApp:()=>{const{coverImage:n,fitImages:r,numRows:o,onEndAction:s}=e.config;t.preloadAudio(b),t.preloadAudio(v);const l=()=>{t.playAudio({source:b})},d=()=>{t.playAudio({source:v})},u=()=>{null===s||void 0===s||s.run()};return()=>(0,i.jsx)(f,{theme:t.theme,images:a,coverImageSrc:String(n.source),fitImages:r,rowsDitributionFromConfig:(0,h.v)(o),onSuccess:l,onFailure:d,onGameWon:u})}})(e,t)}},41381:(e,t,n)=>{n.d(t,{p:()=>a});var i=n(70377),r=n(66264),o=n(60708);function a(e){let{getTargetNodeItem:t,renderApp:n,renderThumbnailApp:a,initialState:s}=e,l=!1;const d=[],u=e=>{d.push(e)};return e=>{const c=t(e.config),m=null===c||void 0===c?void 0:c.parentSlide;function p(){if(!c)return;let e=null;if("idOfFreeNode"in c)e=document.getElementById(c.idOfFreeNode);else{const t=document.createElement("div");t.innerHTML=c.source;let n=t.getElementsByClassName("genially-widget-app");n.length||(n=t.getElementsByClassName("genially-widget-gallery"));const{id:i}=n[0];if(!i)return;e=document.getElementById(i)}if(e){const t=r=>{if(l){const o=n({setState:t,onUnmount:u});i.render(o(r),e)}else console.warn('"rerender" was called when the widget was already unmounted. This is a no-op. Did you forget to dispose of an event handler with "onUnmount"?')};l=!0,t(s),d.push((()=>{i.unmountComponentAtNode(e)}))}}function f(){l=!1,d.forEach((e=>{e()})),d.length=0}null===c||void 0===c||c.on(r.q.Mount,(()=>{p()})),null===c||void 0===c||c.on(r.q.Unmount,(()=>{f()})),c&&"isTransversal"in c&&c.isTransversal?p():null===m||void 0===m||m.on(o.m.Entering,(()=>{l||p()})),null===m||void 0===m||m.on(o.m.Exited,(()=>{c&&"isTransversal"in c&&c.isTransversal||l&&f()})),null===m||void 0===m||m.on(o.m.ThumbnailMount,(()=>{!function(){if(!a||!c||!("idOfThumbnailFreeNode"in c))return;const e=document.getElementsByClassName(c.idOfThumbnailFreeNode);Array.from(e).forEach((e=>{i.unmountComponentAtNode(e)}))}(),function(){if(!a||!c||!("idOfThumbnailFreeNode"in c))return;const e=document.getElementsByClassName(c.idOfThumbnailFreeNode);Array.from(e).forEach((e=>{i.render(a(),e)}))}()}))}}}}]);
//# sourceMappingURL=https://s3-static-genially.genially.com/view/static/js/5086.6124a7c6.chunk.js.map